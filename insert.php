...
if(isset($_POST['submit']))
  {
    ...
    $sql = "INSERT INTO tblusers (ID,FirstName,LastName, MobileNumber, Email, Address)
VALUES (null,'$fname','$lname', '$contno', '$email', '$add')";
	
   
  // Query for data insertion
     //$query=mysqli_query($con, "insert into tblusers(ID,FirstName,LastName, MobileNumber, Email, Address) value('null',$fname','$lname', '$contno', '$email', '$add' )");
